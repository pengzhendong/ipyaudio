...
# -*- coding: utf-8 -*-
#
# ipyaudio documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ipyaudio', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'ipyaudio.tex', 'ipyaudio Documentation',
     'Zhendong Peng', 'manual'),
]
